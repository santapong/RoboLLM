#!/usr/bin/env python3
"""RoboLLM browser dashboard for the ROS 2 robot.
...
one-click Nav2 goals. It reuses robollm.bridge — the same code the MCP server
...
Launch: scripts/launch/dashboard.sh
"""
