...
Updated 2026-09-04 12:58 ICT · santapongsondhi/vla-bed-eval v2 · started ≈ 08:25 ICT (container clock; submitted 07:47 ICT) · 4.5 h elapsed · **ETA ≈ 16:05 ICT (± 20 min)**

- done: 010000 nominal (13 %)
- done: 010000 blank-image probe (0 %)
- done: 010000 gain-0.61 probe (28 %)
- done: 007500 nominal (20 %)
- running: 005000 nominal
- queued: 002500 nominal
- queued: 010000 camera_shift
- queued: 010000 lighting (will be cut by the 7.5 h budget)
- queued: 010000 target_relocation (will be cut by the 7.5 h budget)
- expected: 005000 nominal at ≈ 13:50 ICT
- expected: 002500 nominal at ≈ 14:55 ICT
- expected: 010000 camera_shift at ≈ 16:00 ICT
- expected: finish + pack at ≈ 16:05 ICT
...
| **Learning curve, nominal, n = 100 per checkpoint** | 7.5k: 0.20 (progress 0.32, safety 0.00); 10k: 0.13 (progress 0.29, safety 0.01) | Wilson 7.5k [0.133, 0.289]; 10k [0.078, 0.210] | Kaggle `vla-bed-eval` v2 |
...
- nominal 005000 / 002500 (learning curve)
- variation camera_shift on 010000 (expected to fit the 7.5 h budget)
