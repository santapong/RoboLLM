...
- download vla-bed-baseline-eval.zip from the Kaggle Output tab and run sim/vla-bed/gpu/kaggle_import.sh <zip> 4118f3f718d5cac2b40a64372acafcb994105f0b55d7e6efbe3d1fe8645e9737 (replaces these transcribed numbers with the packed JSONs)
- lighting and target_relocation variations on the 10k checkpoint (cut by the 7.5 h budget; next Kaggle session, after the evaluator speed-ups)
