...
Files under `results/p5/8ac6124fd05b` are the v2 baseline (eval v2), `7a90b7940018` the v2 probe session, `9f5dbf4dd492` the v3 baseline, `145880075d6f` the v4 baseline; names of the form `vX … vs vY …` pair two datasets on identical seeds.
