...
**Status: Planned; Phases 0–3 Verified**, P4 pre-checks passed (P0–P1 and the P4 controls on both machines, P2–P3 on the workstation), 3–4 Sep 2026 (evidence in `results/p0/` … `results/p5/`); P2b LIBERO calibration running; **P4's priced session awaits the owner's go (`GPU-GATE.md`)**. This document is normative. It defines the simulation
